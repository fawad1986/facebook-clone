    ...
    return (
        <div className="signup-container">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <select aria-label = 'Gender' title="Gender" name="gender" value={stateObj.gender} onChange={handleChange}><option  value="Male">Male</option><option  value="Female">Female</option></select>
